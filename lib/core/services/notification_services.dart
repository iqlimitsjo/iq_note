...
//set the setting for the notification
  initializeNotification() async {
    ...
    // create object that receive the notification init setting from android and ios
  ...
  void onDidReceiveNotificationResponse(
    ...
    Get.toNamed(AppRoutes.notificationScreen, arguments: {'payload': payload});
  }
  ...
  scheduledNotification(int hours, int minutes, TaskModel task) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      _nextInstanceOfTenAM(hours, minutes, int.parse(task.taskRemind!),
  ...
  cancelNotification(TaskModel task) async {
    await flutterLocalNotificationsPlugin.cancel(task.taskId!);
  }
  ...
  void _configureSelectNotificationSubject() {
    selectNotificationSubject.stream.listen((String payload) async {
      ...
      Get.toNamed(AppRoutes.notificationScreen, arguments: {
        'payload': payload,
      });
    });
  }
